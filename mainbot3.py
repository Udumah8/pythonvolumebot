...
def status(config_path: str):
    ...
    logger.info(f"  Enable Auto-Funding: {config.funding_config.enable_auto_funding}")
    logger.info(f"  Amount Range: {config.funding_config.min_fund_amount} - {config.funding_config.max_fund_amount} SOL")
